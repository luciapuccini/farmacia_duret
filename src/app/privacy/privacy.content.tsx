...
export const policySections: PolicySection[] = [
  {
    ...
    body: (
      <>
        <p className="mb-3">
          Cuando utilizás la función de reserva por WhatsApp de este sitio, el mensaje que se genera
          puede incluir:
        </p>
        ...
        <p className="mt-3">
          No recopilamos datos de tarjetas de crédito, contraseñas ni información sensible de salud
    ...
    body: (
      <>
        ...
        <ul className="list-disc space-y-1.5 pl-5 text-ink-700">
          ...
          <li>Responderte consultas relacionadas con los productos o servicios de la farmacia.</li>
        </ul>
        <p className="mt-3">
    ...
    body: (
      <>
        <p>
          ...
          <strong className="font-semibold text-ink-900">WhatsApp Business API</strong>, operada por
          Meta Platforms, Inc. Esto implica que los mensajes pasan por la infraestructura de Meta
          sujeta a su propia política de privacidad:{' '}
          <a
  ...
  {
    title: '4. Cuánto tiempo guardamos tus datos',
    body: (
      <p>
        Los datos asociados a tu pedido se conservan mientras el pedido esté activo o hasta que
        solicités su eliminación. No almacenamos historiales de conversaciones de WhatsApp más allá
        del ciclo de vida del pedido.
      </p>
    ),
  },
  {
